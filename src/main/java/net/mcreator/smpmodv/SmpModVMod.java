...
@Mod("smp_mod_v")
public class SmpModVMod {
	public static final Logger LOGGER = LogManager.getLogger(SmpModVMod.class);
	public static final String MODID = "smp_mod_v";
	...
	public SmpModVMod() {
		...
		SmpModVModBlocks.REGISTRY.register(bus);
		...
		SmpModVModMenus.REGISTRY.register(bus);
