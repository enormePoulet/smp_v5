...
public class Modelcopper_left_arm<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("smp_mod_v", "modelcopper_left_arm"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_copper_arm = RightArm.addOrReplaceChild("right_copper_arm",
				CubeListBuilder.create().texOffs(72, 0).addBox(-9.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(5, 91).addBox(-9.2F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(5, 91)
						.addBox(-10.2F, -3.0F, -4.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(-1.0F)).texOffs(0, 76).addBox(-9.0F, 6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(0, 87)
