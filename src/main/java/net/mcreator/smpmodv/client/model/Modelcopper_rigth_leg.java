...
public class Modelcopper_rigth_leg<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("smp_mod_v", "modelcopper_rigth_leg"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_copper_arm = RightArm.addOrReplaceChild("right_copper_arm",
				CubeListBuilder.create().texOffs(72, 0).addBox(-9.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(16, 59).addBox(-9.2F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(16, 59)
						.addBox(-10.2F, -3.0F, -4.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(-1.0F)).texOffs(0, 76).addBox(-9.0F, 6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(80, 21)
		...
		PartDefinition left_copper_arm = LeftArm.addOrReplaceChild("left_copper_arm",
				CubeListBuilder.create().texOffs(68, 24).addBox(-9.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(16, 66).addBox(-9.2F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(48, 74)
		...
		PartDefinition RightArm_r1 = left_copper_arm.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(16, 66).addBox(-15.2F, -4.0F, 2.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(-1.0F)),
		...
		PartDefinition left_copper_leg = LeftLeg.addOrReplaceChild("left_copper_leg",
				CubeListBuilder.create().texOffs(76, 35).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(72, 11).addBox(-2.0F, 6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(7, 104)
		...
		PartDefinition right_copper_leg = RightLeg.addOrReplaceChild("right_copper_leg",
				CubeListBuilder.create().texOffs(76, 54).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(72, 70).addBox(-2.0F, 6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(75, 99)
						.addBox(-2.0F, 5.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(7, 111).addBox(-2.3F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
