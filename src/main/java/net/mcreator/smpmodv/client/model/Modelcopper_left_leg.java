...
public class Modelcopper_left_leg<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("smp_mod_v", "modelcopper_left_leg"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_copper_arm = RightArm.addOrReplaceChild("right_copper_arm",
				CubeListBuilder.create().texOffs(72, 0).addBox(-9.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(5, 81).addBox(-9.2F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(5, 96)
		...
		PartDefinition left_copper_arm = LeftArm.addOrReplaceChild("left_copper_arm",
				CubeListBuilder.create().texOffs(68, 24).addBox(-9.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(5, 88).addBox(-9.2F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(48, 74)
		...
		PartDefinition RightArm_r1 = left_copper_arm.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(5, 88).addBox(-15.2F, -4.0F, 2.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(-1.0F)),
