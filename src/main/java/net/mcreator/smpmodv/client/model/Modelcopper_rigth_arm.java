...
public class Modelcopper_rigth_arm<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("smp_mod_v", "modelcopper_rigth_arm"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition copperbody = Body.addOrReplaceChild("copperbody",
				CubeListBuilder.create().texOffs(24, 0).addBox(-4.0F, -16.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(80, 44).addBox(-4.0F, -24.0F, -2.6F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(30, 78)
						.addBox(-4.0F, -24.0F, -2.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(48, 0).addBox(-4.0F, -24.0F, -2.0F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.4F)),
