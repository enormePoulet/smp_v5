...
public class Modelcopper_center_plate<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("smp_mod_v", "modelcopper_center_plate"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_copper_leg = LeftLeg.addOrReplaceChild("left_copper_leg",
				CubeListBuilder.create().texOffs(76, 35).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(72, 11).addBox(-2.0F, 6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(7, 104)
						.addBox(2.3F, 2.0F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(87, 103).addBox(-2.0F, 5.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
