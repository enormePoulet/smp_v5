...
package net.mcreator.smpmodv.world.inventory;
...
public class TrchstguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TrchstguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SmpModVModMenus.TRCHSTGUI.get(), id);
