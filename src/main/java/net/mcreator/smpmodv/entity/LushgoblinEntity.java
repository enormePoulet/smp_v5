...
public class LushgoblinEntity extends TamableAnimal implements IAnimatable {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1, (float) 10, (float) 20, false) {
			@Override
			public boolean canUse() {
				double x = LushgoblinEntity.this.getX();
				double y = LushgoblinEntity.this.getY();
			...
			public boolean canContinueToUse() {
				...
				Entity entity = LushgoblinEntity.this;
				Level world = LushgoblinEntity.this.level;
				return super.canContinueToUse() && Followplayerquest4Procedure.execute(entity);
			}
		});
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LushgoblinEntity retval = SmpModVModEntities.LUSHGOBLIN.get().create(serverWorld);
